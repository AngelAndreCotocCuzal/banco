...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(429, 548)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(-220, 0, 841, 141))
        self.groupBox.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(7, 52, 255);")
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.label = QtWidgets.QLabel(self.groupBox)
        self.label.setGeometry(QtCore.QRect(340, 30, 231, 51))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(440, 70, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.Login_button = QtWidgets.QPushButton(self.centralwidget)
        self.Login_button.setGeometry(QtCore.QRect(90, 290, 241, 51))
        font = QtGui.QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.Create_Account_Button.setGeometry(QtCore.QRect(90, 350, 241, 51))
        font = QtGui.QFont()
        font.setPointSize(17)
...
"color: rgb(255, 255, 255);")
        ...
        self.label_4.setGeometry(QtCore.QRect(0, 150, 831, 531))
        ...
        self.label_5.setGeometry(QtCore.QRect(0, 140, 821, 16))
        ...
        self.Actualizar_Datos_Button.setGeometry(QtCore.QRect(90, 410, 241, 51))
        font = QtGui.QFont()
        font.setPointSize(17)
...
"color: rgb(255, 255, 255);")
        ...
        self.Actualizar_Datos_Button.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Actualizar_Datos_Button.setText(_translate("MainWindow", "Actualizar Datos"))
